...
export default function FacultyRegistrations({ initialRegistrations }: { initialRegistrations: RegistrationWithEvent[] }) {
  ...
  const handleCancel = async (eventId: string) => {
    setError(null);
    if (!confirm("Are you sure you want to cancel your registration? This action will promote the next Faculty on the waitlist.")) return;
